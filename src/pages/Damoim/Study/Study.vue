          ...
          <b-card-body>
            <form>
              <ul class="form-style-1">
                <li>
                  <label>스터디 제목 <span class="required">*</span></label>
                  <input type="text" v-model="task.title">
                </li>
                <li>
                  <label>스터디 이미지 <span class="required">*</span></label>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {field: "boardsCountry", key: "e", title: "country", width: ""},
        {field: "boardsCity", key: "f", title: "city", width: ""},
        {field: "boardStreet", key: "g", title: "street", width: ""},
  ...
  methods: {
    ...
    save() {
      ...
      if (this.task.id == 0 || !this.task.id) {
        httpService.call('post', 'study', null, null, this.task).then((response) => {
          this.getItems();
        })
      } else {
        httpService.call('put', 'study', null, null, this.task).then((response) => {
          this.getItems();
        })
      }
    ...
    deleteRow(rowIndex) {
      httpService.call('delete', 'study/' + this.items[rowIndex].id, null, null, null).then((response) => {
        this.getItems();
      });
